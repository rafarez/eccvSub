...
%\JZ{To remove an error message related to the subcaption package, I set \textbackslash{}captionsetup\{compatibility=false\} Not sure what the consequences are....}
