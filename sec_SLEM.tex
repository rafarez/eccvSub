...
\end{align}
thus $w$ and $w'$ have the same direction \PP{Not sure to get it What is $\omega$ here? $\omega^{\star}$? Also it says that $\Sigma \omega$ and $\Sigma \omega'$ are aligned, not $\omega$ and $\omega'$.}. In other words, a
