...
\begin{tikzpicture}
	\begin{semilogxaxis}[
		xlabel=Number of distractor images,
		ylabel=mAP,
		legend = south west]
%%Poly SLEM
	...
	\end{semilogxaxis}
\end{tikzpicture}
\caption{mAP for Oxford5k varying the number of distractors, using SPoC features and different methods of SLEM (see legend).}
\label{vlad:oxford}
\end{figure}
